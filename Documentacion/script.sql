...
USE fullstackbd;
  ...
  FOREIGN KEY (id_tipo1) REFERENCES tipo_animales(id_tipo));
  ...
  CREATE TABLE adopciones_animales (
  id_adopcion INT NOT NULL AUTO_INCREMENT,
  dni_usuario1 VARCHAR(45) NOT NULL,
  id_animal1 INT NOT NULL,
  PRIMARY KEY (id_adopcion),
  FOREIGN KEY (dni_usuario1) REFERENCES usuario(dni_usuario),
  FOREIGN KEY (id_animal1) REFERENCES animales(id_animal));
